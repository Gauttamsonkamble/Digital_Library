...
if($_POST['forgetpwd'])
{
  ...
  $msg=$obj->checkMobileEmail($email11,$mobileno1,$pwd11);
...
<div class="modal-footer justify-content-center">
  <input type="submit" name="register" class="btn btn-indigo" value="Register">
...
<div class="modal fade left" id="fluidModalleftSuccessDemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
aria-hidden="true" data-backdrop="false">
<div class="modal-dialog modal-full-height modal-right modal-notify modal-success" role="document">
<!--Content-->
<div class="modal-content">
<!--Header-->
<div class="modal-header">
<p class="heading lead">Forget Password</p>
...
<div class="modal-body">
      ...
      <div id="forgetp" style="display: block;">
          ...
          <!-- Form -->
                 ...
                 <div class="md-form">
                    <i class="fa fa-envelope prefix grey-text"></i>
                    <br>
                    <input type="email" id="form2" class="form-control" name="email11">
                    <label for="form2">Enter Email</label>
                  </div>
                  <div class="md-form">
                    <i class="fa fa-envelope prefix grey-text"></i>
                    <br>
                    <input type="text" id="form3" class="form-control" name="mobileno1">
                    <label for="form3">Enter Mobile Number</label>
                  </div>
                  ...
                  <div class="md-form">
                    <i class="fa fa-user prefix grey-text"></i>
                   <br>
                    <input type="password" id="form3" class="form-control" name="pwd11">
                    <label for="form3">Enter New password</label>
                  </div>

                  <input type="submit" name="forgetpwd" class="btn btn-indigo" value="Change Password">
              ...
              <div class="card-body">
                ...
                <div id="Login" style="display: block;">
                  ...
                  <div class="text-center">
                     ...
                     <a href="#" onclick="showForgetPassword()" data-toggle="modal" data-target="#fluidModalleftSuccessDemo" style="color: red;">Forget Password?</a>
